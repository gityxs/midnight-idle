...
var cnItems = {
    ...
    "From the fallen troll, you retrieve a gleaming amulet radiating intense energy and power. As you place it around your neck, a surge of vitality courses through you. The amulet's enchantment enhances your agility, making you feel lighter on your feet and capable of moving with remarkable speed.<br><br>Exploration gain (+10)<br><br> You resume your journey.": "从倒下的巨魔那里，你找回了一个闪闪发光的护身符，散发出强烈的能量和力量。当你把它戴在脖子上时，一股活力涌上全身。护身符的魔力增强了你的敏捷性，让你感觉你的脚更轻，能够以惊人的速度移动。<br><br>探索收益(+10)<br><br>你继续你的旅程。",
    "PERFECT LIE": "完美的谎言",
    "As a cunning goblin, you approach the cave troll with confidence, claiming that the master has sent you to ensure he isn’t shirking his duties. Noting that he is clearly alert and diligent, you casually add that you’ll report his excellent performance to the boss. The troll, flattered by your words, grunts in approval and allows you to pass without any trouble<br><br>+25 XP.": "作为一个狡猾的哥布林，你自信地接近洞穴巨魔，声称主人派你来确保他没有逃避他的职责。注意到他显然机警而勤奋，你漫不经心地补充说，你会向老板报告他的出色表现。巨魔，被你的话奉承了，发出赞许的咕噜声，让你顺利通过<br><br>+25经验值。",
    "QUICK SPRINT": "快速冲刺",
    ...
    "In the distance, a towering dark fortress rises ominously, its jagged spires casting long shadows over the surrounding chasm filled with molten lava. The heat radiates in waves, and an unshakable sense of finality settles over you—you know your journey is nearing its end. As you approach, memories of your arduous path resurface. The battles, the choices, and the transformations have brought you here, yet the mystery of your black, oozing form remains unsolved. Deep down, you are certain the answers you seek lie within the fortress's darkened halls.<br><br>Unlocked Sanity Recall.": "远处，一座高耸的黑暗堡垒不祥地矗立着，它参差不齐的尖顶在周围充满熔岩的裂缝上投下长长的阴影。热量像波浪一样散发出来，一种不可动摇的终结感笼罩着你——你知道你的旅程即将结束。当你靠近的时候，你艰难的记忆重新浮现。战斗、选择和转变把你带到了这里，但你黑色、渗出的身体之谜仍未解开。在内心深处，你确信你寻找的答案就在堡垒黑暗的大厅里。<br><br>解锁理智召回。",
    ...
    "REINFORCEMENTS": "增援部队",
    "The group of veteran goblins you persuaded earlier in the living quarters arrives to aid you. Armed with crude weapons and a spark of courage, they charge at the Blood Gargoyle with reckless determination. However, they are no match for its overwhelming power, their numbers dwindling rapidly with each passing moment. Seizing the opportunity, you make a hasty and cowardly escape, dashing up the stairs while leaving the goblins to their grim fate.<br><br>+50 XP": "你之前在生活区说服的一群经验丰富的哥布林来帮助你。带着粗糙的武器和一丝勇气，他们毅然决然地冲向血兽。然而，它们无法与其压倒性的力量相抗衡，它们的数量每时每刻都在迅速减少。抓住这个机会，你做了一个匆忙而懦弱的逃跑，冲上楼梯，留下妖精们的残酷命运。<br> <br> + 50 XP",
    "ACCEPT OFFER": "接受提议",
    ...
    "DISINTEGRATE": "瓦解",
    "You have done well, my faithful servant... but the <i>Legion</i> demands more. The darkness hungers, and the harvest is far from complete. Go forth and reap, claim the souls I require. I need at least two thousand to ascend beyond this plane. Obey, my loyal pet, and let no one escape the grasp of our shadow. Go now... and do my bidding.<br><br>Your ooze-like body begins to wither, every trace of moisture evaporating as it crumbles into brittle black ash. A sudden, chilling gust of wind sweeps through, lifting the fragile remnants skyward before scattering them into oblivion. Nothing remains, as if you were never there at all.": "你做得很好，我忠实的仆人……但是<i b>军团</i>要求更多。黑暗如饥似渴，收获远未完成。去收割吧，夺取我所需要的灵魂。我至少需要两千块才能升出这层楼。服从吧，我忠诚的宠物，不要让任何人逃脱我们的魔掌。走了……照我说的做。你的软泥般的身体开始枯萎，每一丝水分都蒸发了，因为它变成了脆黑的灰烬。一阵突如其来的寒风吹过，把脆弱的残余物吹向天空，然后又把它们吹得无影无踪。什么都没有留下，就好像你从来没有在那里。",
