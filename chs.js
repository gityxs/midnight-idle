...
var cnItems = {
    ...
    "NEW CLASS": "新种族",
    "Spare Goblin": "饶恕哥布林",
    "Defeated, the goblin collapses to the floor, barely clinging to life. As it struggles for breath, you are faced with a pivotal choice: absorb the goblin to gain its form and potential abilities, or reject the transformation and remain in your current feral, animalistic state. The decision is yours to make.": "小妖精被打败了，倒在地上，奄奄一息。当它挣扎着呼吸时，你面临着一个关键的选择：吸收哥布林以获得它的形态和潜在的能力，或者拒绝转变并保持你目前的野性，动物形态。决定权在你。",
    ...
    "THE MESS HALL": "食堂",
    "You step cautiously into what appears to be the dungeon's mess hall, a space teeming with goblins. The air is thick with the sound of their chatter and the clatter of crude utensils. For now, they remain blissfully unaware of your presence. Across the room, you spot the exit—your way forward—but it lies beyond the sea of goblins. At the center of the hall, a goblin king lounges on a makeshift throne, lazily overseeing his minions. You pause, weighing your options and planning your next move.": "你小心翼翼地走进地牢的食堂，一个挤满了哥布林的地方。空气中充满了他们聊天的声音和粗糙器皿的碰撞声。现在，他们幸福地不知道你的存在。穿过房间，你找到了出口——你前进的方向——但它位于妖精的海洋之外。在大厅中央，一个半兽人国王懒洋洋地坐在一个临时搭建的宝座上，懒洋洋地监督着他的仆从们。你停下来，权衡你的选择，计划下一步行动。",
    "WOLF FORM": "狼形态",
